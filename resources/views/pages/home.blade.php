<x-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
                ...
                <x-card title="Layanan Teknologi Informasi" theme="light"
                    ...
                    <ul class="mt-6 space-y-3 text-sm text-gray-600">
                        <li class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-accent"></div> Setup & Konfigurasi Server (ACS, dll)
                        </li>
                        <li class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-accent"></div> Konsultasi & Audit Infrastruktur
                        </li>
                        <li class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-accent"></div> IT Support & Maintenance Terjadwal
                        </li>
                    </ul>
                </x-card>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                ...
                <div class="lg:col-span-5">
                    <div
                        class="bg-navy rounded-2xl p-8 border border-gray-soft/10 h-full flex flex-col justify-center relative overflow-hidden group">
                        <!-- BG accent element -->
                        <div
                        ...
                        <div class="space-y-4 relative z-10">
                            <div class="pb-4 border-b border-gray-soft/10 flex justify-between items-center">
                                <span class="block text-sm text-gray-500">Entitas Badan Hukum</span>
                                <span class="font-semibold text-white tracking-wide text-sm">Perseroan Terbatas
                                    (PT)</span>
                            </div>
                            <div class="pb-4 border-b border-gray-soft/10 flex justify-between items-center">
                                <span class="block text-sm text-gray-500">Nomor Induk Berusaha (NIB)</span>
                                <span class="font-semibold text-accent tracking-wide text-sm flex items-center gap-1">
                            ...
                            <div class="pt-2">
                                <span class="block text-sm text-gray-500 mb-2">Kode Spesialisasi KBLI Utama</span>
                                <div class="flex gap-2">
                                    <span
                                        class="px-3 py-1 bg-navy rounded border border-accent/30 text-xs text-accent font-medium">62019</span>
                                    <span
                                        class="px-3 py-1 bg-navy rounded border border-accent/30 text-xs text-accent font-medium">62090</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-soft/10 relative z-10">
                            <a href="{{ route('about') }}"
                                class="text-sm font-medium text-accent hover:text-white transition-colors flex items-center">
    ...
    <section class="py-24 bg-accent relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h2 class="text-4xl md:text-5xl font-extrabold text-navy mb-6 tracking-tight">Siap Skalakan Bisnis Anda
                Bersama Kami?</h2>
            <p class="text-xl text-navy/80 mb-10 mx-auto max-w-2xl font-medium">
