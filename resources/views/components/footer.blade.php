            ...
            <div class="col-span-1 md:col-span-2">
                <a href="{{ route('home') }}" class="flex items-center space-x-2 group mb-6">
                    ...
                    <div class="flex flex-col">
                        <span
                            class="text-xl font-bold text-white tracking-tight leading-none group-hover:text-accent transition-colors">Kita
                            Cerdas</span>
                        <span
                            class="text-[10px] text-accent font-semibold tracking-[0.2em] uppercase leading-none mt-1">Digital</span>
                    </div>
                </a>
                ...
                <ul class="space-y-3 text-sm">
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <a href="mailto:admin@kitacerdasdigital.site"
                            class="hover:text-accent transition-colors">admin@kitacerdasdigital.site</a>
                    </li>
                    <li class="flex items-center gap-2">
                        <svg class="w-5 h-5 text-accent shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        ...
                        <a href="https://wa.me/6282317113029" class="hover:text-accent transition-colors">+62
                            823-1711-3029</a>
                    </li>
                </ul>
            </div>
